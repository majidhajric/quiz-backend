...
public class QuizTemplateController {
    ...
    public Mono<QuizTemplate> getQuizDetails(@PathVariable String templateId) {
        return quizService.getQuizTemplate(templateId);
    }
    ...
    @PostMapping(path = "/{templateId}/quiz")
    public Mono<Quiz> createQuiz(@PathVariable String templateId) {
        return quizService.createQuiz(templateId);
    }
